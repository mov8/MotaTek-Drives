...
class ShopTile extends StatefulWidget {
  ...
  @override
  State<ShopTile> createState() => _HomeTileState();
}

class _HomeTileState extends State<ShopTile> {
  ...
  Widget driveDetails() {
    ...
    String data = widget.shopItem.markdown;
    MdStyleSheet _styleSheet =
        MdStyleSheet.fromJson(json: widget.shopItem.style ?? {});
    return Padding(
